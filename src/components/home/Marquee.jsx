...
import { Stethoscope, Flag, ShieldCheck, FlaskConical, Truck, Clock } from "lucide-react";

/**
 * Scrolling credential marquee. Sits between the navbar and the hero as a slim
 * dark band. Colors flow from the live palette so it re-skins with the theme.
 */
const ITEMS = [
