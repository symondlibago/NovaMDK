...
export const productsData = [
  ...
  },
  {
    ...
    subtitle: "Semaglutide is a GLP-1 receptor agonist that works on pathways involved in appetite and food intake. This compounded formulation also contains cyanocobalamin, a form of vitamin B12, and is administered once weekly.",
    price: "$169",
    shipping: "Discreetly to Your Door",
    dosageForm: "Weekly Subcutaneous Injection",
    icon: <Syringe size={16} />,
  ...
  },
  {
    ...
    subtitle: "Tirzepatide works on two hormone pathways, GIP and GLP-1, that are involved in appetite and food intake. This compounded formulation also contains niacinamide and is administered once weekly.",
    price: "$179",
    shipping: "Discreetly to Your Door",
    dosageForm: "Weekly Subcutaneous Injection",
    icon: <Syringe size={16} />,
...

  {
    ...
    subtitle: "A compounded prescription cream formulated for concerns such as dark spots, uneven skin tone, and post-inflammatory hyperpigmentation.",
    price: "$99",
    shipping: "Discreetly to Your Door",
  ...
  },
  {
    ...
    subtitle: "A compounded sublingual prescription designed to address multiple aspects of sexual response, including desire, arousal, and blood flow. It combines tadalafil, bremelanotide, and oxytocin in one flex-dose tablet.",
    price: "$79",
    shipping: "Discreetly to Your Door",
    dosageForm: "Sublingual Flex-Dose Tablet",
    icon: <Flame size={16} />,
  ...
  },
  {
    ...
    size: "5 mL vial",
    subtitle: "PT-141 is a prescription treatment that acts on melanocortin pathways involved in sexual desire and arousal. Unlike treatments that focus primarily on blood flow, bremelanotide works through central signaling pathways connected to sexual response, offering a different approach to sexual wellness.",
    price: "$149",
    priceSuffix: "/mo",
    shipping: "Discreetly to Your Door",
    dosageForm: "Subcutaneous Injection",
  ...
  },
  {
    ...
    size: "10 or 25 mg/mL",
    subtitle: "PT-141 (bremelanotide) is a prescription treatment that acts on melanocortin pathways involved in sexual desire and response. This compounded nasal formulation offers a needle-free way to take PT-141, with dosing and use determined by a licensed provider based on your individual treatment plan",
    price: "$149",
    priceSuffix: "/mo",
    shipping: "Discreetly to Your Door",
    dosageForm: "Nasal Spray",
