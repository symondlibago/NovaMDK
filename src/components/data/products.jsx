...
export const productsData = [
  ...
  },
  {
    ...
    subtitle: "A compounded GLP-1 receptor agonist that acts on the appetite and blood-sugar signalling pathway, blended with cyanocobalamin (B12) to help offset nausea. Given as a once-weekly subcutaneous injection.",
    price: "$169",
    shipping: "Discreetly to Your Door",
    dosageForm: "Weekly Subcutaneous Injection",
    icon: <Syringe size={16} />,
  ...
  },
  {
    ...
    qrImg: "/qr/semaglutide.png",
    subtitle: "Once-weekly semaglutide compounded with cyanocobalamin (B12). Semaglutide works on the GLP-1 pathway that regulates appetite and fullness, while B12 supports energy and helps ease nausea.",
    price: "$169",
    shipping: "Discreetly to Your Door",
    dosageForm: "Weekly Subcutaneous Injection",
    icon: <Syringe size={16} />,
  ...
  },
  {
    ...
    subtitle: "A dual GIP and GLP-1 receptor agonist, acting on two appetite and metabolic pathways at once, compounded with niacinamide for metabolic support. Once-weekly subcutaneous injection.",
    price: "$179",
    shipping: "Discreetly to Your Door",
    dosageForm: "Weekly Subcutaneous Injection",
    icon: <Syringe size={16} />,
  ...
  },
  {
    ...
    qrImg: "/qr/tirzepatide.png",
    subtitle: "Once-weekly tirzepatide compounded with niacinamide. Tirzepatide targets both the GIP and GLP-1 receptors, acting on appetite, fullness and metabolic signalling together.",
    price: "$199",
    shipping: "Discreetly to Your Door",
    dosageForm: "Weekly Subcutaneous Injection",
    icon: <Syringe size={16} />,
  ...
  },
  {
    ...
    qrImg: "/qr/tirzepatide.png",
    subtitle: "Dual-receptor tirzepatide with niacinamide, given once weekly by subcutaneous injection to act on appetite regulation and metabolic signalling.",
    price: "$229",
    shipping: "Discreetly to Your Door",
    dosageForm: "Weekly Subcutaneous Injection",
    icon: <Syringe size={16} />,
  ...
  },
  {
    ...
    imgDetail: "/products/detail/lipo-c.avif",
...

  {
    ...
    subtitle: "NAD+ is a coenzyme central to cellular energy production and DNA repair, and levels decline with age. Given as a subcutaneous injection to support metabolism, focus and recovery.",
    price: "$139",
    shipping: "Discreetly to Your Door",
    dosageForm: "Weekly Subcutaneous Injection",
    icon: <Zap size={16} />,
  ...
  },
  {
    ...
    qrImg: "/qr/NAD+ Injection.avif",
    subtitle: "An injectable form of nicotinamide adenine dinucleotide, the coenzyme cells use to turn nutrients into usable energy. Delivered subcutaneously or intramuscularly.",
    price: "$129",
    shipping: "Discreetly to Your Door",
  ...
  },
  {
    ...
    size: "6 mL vial (1200 mg)",
    qrImg: "/qr/NAD+ Injection.avif",
    subtitle: "Injectable NAD+, a coenzyme involved in cellular energy metabolism, DNA repair and sirtuin activity. Given by subcutaneous or intramuscular injection.",
    price: "$129",
    shipping: "Discreetly to Your Door",
    dosageForm: "Subcutaneous / IM Injection",
    icon: <Zap size={16} />,
  ...
  },
  {
    ...
    qrImg: "/qr/NAD+ Injection.avif",
    subtitle: "Injectable NAD+, supporting the mitochondrial pathways behind energy, cognitive clarity and cellular repair. Given subcutaneously or intramuscularly.",
    price: "$179",
    shipping: "Discreetly to Your Door",
    dosageForm: "Subcutaneous / IM Injection",
    icon: <Zap size={16} />,
...

  {
    ...
    subtitle: "Naltrexone prescribed at a fraction of its standard dose, where it is used to modulate immune signalling and the body's own endorphin response. Taken nightly as an oral tablet.",
    price: "$39",
    shipping: "Discreetly to Your Door",
  ...
  },
  {
    ...
    size: "3 mg flex-dose",
    qrImg: "/qr/Low Dose Naltrexone (LDN).avif",
    subtitle: "Low-dose naltrexone, an oral tablet taken at bedtime. At these doses naltrexone is used to temper inflammatory signalling and support the body's own endorphin production.",
    price: "$39",
    shipping: "Discreetly to Your Door",
    dosageForm: "Oral Tablet",
    icon: <Shield size={16} />,
  ...
  },
  {
    ...
    qrImg: "/qr/Low Dose Naltrexone (LDN).avif",
    subtitle: "Low-dose naltrexone, taken nightly as an oral tablet and used to modulate immune and inflammatory signalling for chronic pain, inflammation and recovery.",
    price: "$109",
    shipping: "Discreetly to Your Door",
    dosageForm: "Oral Tablet",
    icon: <Shield size={16} />,
...

  {
    ...
    subtitle: "A prescription topical blend of azelaic acid, hydroquinone and kojic acid with green tea EGCG and resveratrol, formulated to target dark spots, uneven tone and post-inflammatory pigmentation.",
    price: "$99",
    shipping: "Discreetly to Your Door",
  ...
  },
  {
    ...
    subtitle: "A sublingual flex-dose tablet pairing tadalafil, which works on blood flow, with oxytocin and bremelanotide, which act on desire and arousal pathways rather than circulation alone.",
    price: "$79",
    shipping: "Discreetly to Your Door",
    dosageForm: "Sublingual Flex-Dose Tablet",
    icon: <Flame size={16} />,
