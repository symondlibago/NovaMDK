...
export const CONSULTS = {
  "weight-loss": {
    ...
    short: "Weight Loss",
    blurb: "Personalized, provider-guided treatment options for weight management.",
    Icon: Scale,
    img: "/site/supplementpill.avif",
  ...
  skin: {
    ...
    name: "Skin Health",
    short: "Skin Health",
    blurb: "Provider-guided prescription options for common skin concerns.",
    Icon: Sparkles,
    img: "/site/pill.avif",
    goalSlug: "skin-health",
    steps: [
      { t: "intro", eyebrow: "Skin Health", title: "Let’s get you glowing.",
  ...
  intimacy: {
    ...
    short: "Sexual Health",
    blurb: "Discreet, provider-guided treatment options for your sexual health goals.",
    Icon: Heart,
  ...
  recovery: {
    ...
    blurb: "Provider-guided options for recovery and wellness goals.",
    Icon: Activity,
    img: "/site/sportpill.avif",
    goalSlug: "recovery-wellness",
    steps: [
      { t: "intro", eyebrow: "Recovery & Wellness", title: "Let’s get you recovering faster.",
  ...
  longevity: {
    ...
    name: "Longevity",
    short: "Longevity",
    blurb: "Provider-guided options based on your individual longevity and wellness goals.",
    Icon: InfinityIcon,
    img: "/site/antipill.avif",
    goalSlug: "longevity",
    steps: [
      { t: "intro", eyebrow: "Longevity", title: "Let’s help you stay timeless.",
