...
const legalDocuments = {
  ...
  'privacy-policy': {
    ...
    intro: [
      ...
      'IMPORTANT — Two Different Privacy Frameworks. Nova MDK operates a technology platform that facilitates connections between Users and (i) a network of independent physicians and other clinicians licensed in the U.S. ("Platform Providers"), and (ii) third-party pharmacies licensed to provide pharmacy services across the U.S. ("Platform Pharmacies"). The Platform Providers and Platform Pharmacies are identified below.',
