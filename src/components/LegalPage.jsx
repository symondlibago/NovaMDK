...
const legalDocuments = {
      ...
      },
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            text: 'To access certain features, you must create an account. You agree to keep your login credentials confidential and to be solely responsible for all activity that occurs under your account. You agree to notify NovaMDK immediately at support@novamdk.com if you believe your account has been compromised. Each account is for a single individual. You may not share an account, sell access to your account, or allow any other person to use your account or your prescription medications.',
          },
        ],
      },
      {
  ...
  'privacy-policy': {
    ...
    intro: [
      ...
      'IMPORTANT — Two Different Privacy Frameworks. NovaMDK operates a technology platform that facilitates connections between Users and (i) a network of independent physicians and other clinicians licensed in the U.S. ("Platform Providers"), and (ii) third-party pharmacies licensed to provide pharmacy services across the U.S. ("Platform Pharmacies"). The Platform Providers and Platform Pharmacies are identified below.',
  ...
  'telehealth-consent': {
    ...
    content: [
      ...
      },
      {
        ...
        text: 'You have the right to withdraw your consent to the use of telehealth at any time, without affecting your right to future care or treatment and without losing or risking the loss of any benefits to which you are otherwise entitled. To withdraw your consent, send written notice to your Provider through the Platform or email medteam@novamdk.com. You understand that withdrawal of consent will not affect any action taken by NovaMDK, the PG, or your Provider in reliance on this Consent before the withdrawal was received. You also understand that PG Providers do not offer in-person care, so withdrawal of your consent to telehealth means that you will need to seek care from a different provider.',
        subsections: [
          {
            heading: 'Right to Refuse',
            text: 'You may also refuse to use telehealth for any particular visit and may instead seek in-person care from a different provider, without any penalty from NovaMDK or PG.',
          },
        ],
      },
      {
    ...
    content: [
      {
        ...
        text: 'This Notice of Privacy Practices ("Notice") is provided by the independent professional medical group whose affiliated physicians provide clinical care to you through the NovaMDK telehealth platform ("Platform Providers," "PG," "we," "us," or "our"). PG is a "covered entity" under the federal Health Insurance Portability and Accountability Act of 1996 and its implementing regulations ("HIPAA"). This Notice applies to the protected health information ("PHI") created or received by PG and its affiliated providers and workforce in the course of providing you care. It describes our legal duties and your rights concerning your PHI. NovaMDK\'s handling of non-clinical platform information is described separately in the NovaMDK Privacy Policy and Consumer Health Data Privacy Notice; those notices are not a substitute for this Notice.',
      },
      {
      ...
      },
      {
        ...
        text: 'To exercise any of your rights, to request a paper copy of this Notice, or to ask questions or file a complaint, contact the NovaMDK Privacy Officer:\n\nNovaMDK — Privacy Officer\n15570 Brookhurst St #238\nWestminster, CA 92683\nprivacy@novamdk.com',
      },
    ],
