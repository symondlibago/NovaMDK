...
const legalDocuments = {
  'terms-and-conditions': {
    ...
    intro: [
      'PLEASE READ THESE TERMS OF SERVICE CAREFULLY. These Terms of Service (the "Terms") constitute a legally binding agreement between you ("you," "your," or "User") and NovaMDK ("NovaMDK," "we," "us," or "our") governing your access to and use of the NovaMDK website, mobile applications, and related services (collectively, the "Platform" or "Services").',
    ...
    content: [
      {
        heading: '1. About NovaMDK',
        text: 'NovaMDK is a technology platform that facilitates access to telehealth medical consultations and prescription medication services. NovaMDK itself is not a medical provider, does not provide medical advice, and does not practice medicine, pharmacy, or any other licensed profession.',
        subsections: [
          {
            heading: '1.1 The NovaMDK Ecosystem',
            text: 'The Services are provided through the coordinated efforts of three distinct entities:\n\nNovaMDK (the Platform). NovaMDK operates the Platform technology, manages customer accounts and billing, coordinates communications, and facilitates connections between Users, medical providers, and pharmacies. NovaMDK is a technology and administrative services company.\n\nNovaMDK Physician Group ("NPG"). NPG is an independent, professionally licensed medical group composed exclusively of physicians who hold an active Doctor of Medicine (M.D.) license in good standing in the state in which the User is located at the time of consultation (each, a "Provider"). NPG does not utilize Doctors of Osteopathic Medicine (D.O.), physician assistants, nurse practitioners, or other non-M.D. clinicians to evaluate Users or issue prescriptions through the Platform. Providers affiliated with NPG are responsible for evaluating Users, establishing the physician-patient relationship, making clinical decisions, issuing prescriptions when medically appropriate, and providing all medical care. NPG operates independently of NovaMDK, and NovaMDK does not control, direct, or interfere with the independent medical judgment of any Provider.\n\nNovaMDK Drug Group (the "Pharmacy"). NovaMDK Drug Group is a licensed pharmacy authorized to dispense prescription medications in all 50 United States. The Pharmacy is responsible for the dispensing, labeling, packaging, and shipment of prescription medications pursuant to prescriptions issued by Providers. The Pharmacy operates independently in accordance with applicable federal and state pharmacy laws and regulations.\n\nNPG and NovaMDK Drug Group are independent entities that contract with NovaMDK for non-clinical administrative and technology support. Nothing in these Terms creates a partnership, joint venture, or agency relationship that would cause NovaMDK to be deemed to be practicing medicine, pharmacy, or any other licensed profession.',
          },
          {
      ...
      },
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            text: 'The Services are designed to complement, not replace, an ongoing relationship with a primary care provider. NovaMDK strongly encourages every User to maintain a relationship with a primary care physician and to share information about consultations and medications obtained through the Platform with that provider and any other treating clinicians.',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            text: 'NovaMDK Providers do not prescribe medications that are scheduled controlled substances under the U.S. Drug Enforcement Administration (DEA) schedules I through V. Requests for controlled substances will be declined.',
          },
          {
            heading: '6.3 Refills and Continuation of Therapy',
            text: 'Refills are not automatic. Continued therapy may require check-ins, follow-up consultations, lab work, or other clinical assessments at intervals determined by the Provider. NovaMDK may send reminders, but it is your responsibility to request refills in time and to provide updated information when requested.',
          },
          {
      ...
      },
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            text: 'By providing a payment method, you authorize NovaMDK (and its payment processors) to charge that payment method for all amounts due, including consultation fees, prescription fees, recurring subscription fees, taxes, and any applicable shipping or service charges. You represent that you are authorized to use the payment method you provide.',
          },
          {
            heading: '7.3 Subscriptions and Auto-Renewal',
            text: 'Many NovaMDK offerings are sold on a subscription basis. Subscriptions automatically renew at the end of each billing cycle (monthly, quarterly, or as otherwise specified at checkout) at the then-current renewal price, until cancelled. By starting a subscription, you authorize NovaMDK to charge your payment method on a recurring basis without further authorization, until you cancel.',
          },
          {
        ...
        subsections: [
          {
            ...
            text: 'Before initiating any formal proceeding, you agree to first contact NovaMDK at support@novamdk.com and provide a brief written description of the dispute and your contact information. The parties shall attempt in good faith to resolve the dispute informally for at least sixty (60) days before initiating arbitration.',
          },
          {
      ...
      },
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            text: 'No waiver of any term of these Terms shall be deemed a further or continuing waiver of such term or of any other term. NovaMDK\'s failure to assert any right or provision under these Terms shall not constitute a waiver.',
          },
          {
            heading: '19.5 Assignment',
            text: 'You may not assign or transfer these Terms or any of your rights or obligations under them without NovaMDK\'s prior written consent. NovaMDK may assign these Terms without restriction. Any prohibited assignment is void.',
          },
          {
            heading: '19.6 Force Majeure',
            text: 'NovaMDK shall not be liable for any failure or delay in performance caused by circumstances beyond our reasonable control, including without limitation acts of God, natural disasters, war, terrorism, civil unrest, labor disputes, government action, public health emergencies, supply-chain disruptions, internet outages, or carrier delays.',
          },
          {
  ...
  'privacy-policy': {
    ...
    lastUpdated: 'June 20, 2026',
    intro: [
      'This Privacy Policy describes how NovaMDK ("NovaMDK," "we," "us," or "our") collects, uses, shares, and protects information in connection with our website, mobile applications, and related services (collectively, the "Platform" or "Services"). This Privacy Policy applies to information we collect as the operator of the Platform.',
      'IMPORTANT — Two Different Privacy Frameworks. NovaMDK operates a technology platform that facilitates connections between Users and (i) NovaMDK Physician Group ("NPG"), an independent medical group of M.D. physicians, and (ii) NovaMDK Drug Group, a 50-state licensed pharmacy. Information you provide directly to NPG or NovaMDK Drug Group as part of your medical care — your medical history, intake answers, prescriptions, lab results, and clinical communications with your doctor — is protected health information ("PHI") governed by the federal Health Insurance Portability and Accountability Act ("HIPAA") and is described in NPG\'s separate Notice of Privacy Practices. This Privacy Policy describes our handling of non-PHI personal information collected through the Platform, such as account, contact, payment, device, and marketing data.',
    ...
    content: [
      {
        ...
        text: 'This Privacy Policy applies to information we collect:\n\n• On the NovaMDK website and any subdomain operated by NovaMDK;\n• Through any NovaMDK mobile application;\n• Through email, text message, telephone, or other electronic communications between you and NovaMDK; and\n• Through any third-party platforms, advertising networks, or social-media features that direct you to or from the Platform.\n\nThis Privacy Policy does not apply to information collected by:\n\n• NPG or its M.D. Providers in their capacity as healthcare providers (governed by NPG\'s Notice of Privacy Practices and HIPAA);\n• NovaMDK Drug Group as a licensed pharmacy (governed by HIPAA, applicable state pharmacy laws, and NovaMDK Drug Group\'s Notice of Privacy Practices);\n• Any third-party website, application, or service that the Platform may link to; or\n• Information collected offline or through any channel other than the Platform.',
      },
      {
  ...
  'consumer-health-data': {
    ...
    closing: 'By using the Services, you acknowledge that you have read this Consumer Health Data Privacy Notice and understand how NovaMDK collects, uses, shares, and protects your Consumer Health Data.',
  }
};
